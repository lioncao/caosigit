...
func testUint16() {
	...
	for ix, elem := range tmpAryUint16 {
		tmpAry[ix] = elem
	}
	testSet(tmpAry)
}
...
func testUint32() {
	...
	for ix, elem := range tmpAryUint32 {
		tmpAry[ix] = elem
	}
	testSet(tmpAry)
}
...
func testUint64() {
	...
	for ix, elem := range tmpAryUint64 {
		tmpAry[ix] = elem
	}
	testSet(tmpAry)
}
...
func testUintptr() {
	...
	for ix, elem := range tmpAryUintptr {
		tmpAry[ix] = elem
	}
	testSet(tmpAry)
}
...
func testFloat32() {
	...
	for ix, elem := range tmpAryFloat32 {
		tmpAry[ix] = elem
	}
	testSet(tmpAry)
}
...
func testFloat64() {
	...
	for ix, elem := range tmpAryFloat64 {
		tmpAry[ix] = elem
	}
	testSet(tmpAry)
}
...
func testComplex64() {
	...
	for ix, elem := range tmpAryComplex64 {
		tmpAry[ix] = elem
	}
	testSet(tmpAry)
}
...
func testComplex128() {
	...
	for ix, elem := range tmpAryComplex128 {
		tmpAry[ix] = elem
	}
	testSet(tmpAry)
}
