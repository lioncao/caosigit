...
# list="$list caosi"
# list="$list caosi/net"
list="$list caosi/net/http"
list="$list caosi/net/socket"
# list="$list caosi/util"
list="$list caosi/util/cmd"
# list="$list caosi/util/db"
list="$list caosi/util/db/mongodb"
list="$list caosi/util/db/redis"
list="$list caosi/util/network"
list="$list caosi/util/service"
list="$list caosi/util/tools"
